...
- If use adb via the EVB board:
    ...
    ```shell
    adb push install/rk356x_linux_aarch64/rknn_LPRNet_demo/ /userdata/
    ```
...
export LD_LIBRARY_PATH=./lib
./rknn_lprnet_demo model/lprnet.rknn model/test.jpg
for img in model/test_imgs/*; do echo "===== 测试图片: $img =====" && ./rknn_lprnet_demo model/lprnet.rknn $img; done
```
