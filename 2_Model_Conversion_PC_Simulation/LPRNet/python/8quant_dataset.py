...
SOURCE_DATA_ROOT = PROJECT_ROOT / "1_PC_Training" / "datasets" / "lprnet_8char"
SOURCE_TXT_DIR = SOURCE_DATA_ROOT / "classified_txts"
LPRNET_TIGHT_TRAIN = SOURCE_DATA_ROOT / "lprnet_8char_tight_train"
LPRNET_TIGHT_VAL = SOURCE_DATA_ROOT / "lprnet_8char_tight_val"
YOLO_CROPS_BLUE_TRAIN = PROJECT_ROOT / "1_PC_Training" / "datasets" / "yolo_lprnet_crops" / "green" / "train"
RAW_IMAGE_DIR = PROJECT_ROOT / "2_Model_Conversion_PC_Simulation" / "LPRNet" / "model" / "lprnet8_raw_images"
QUANT_DATASET_DIR = PROJECT_ROOT / "2_Model_Conversion_PC_Simulation" / "LPRNet" / "model" / "lprnet8_quant_dataset"
DATASET_TXT = PROJECT_ROOT / "2_Model_Conversion_PC_Simulation" / "LPRNet" / "model" / "lprnet8_dataset.txt"

DEFAULT_PER_CLASS = 200
DEFAULT_YOLO_CROPS_COUNT = 200
DEFAULT_SEED = 42
    ...
    with open(txt_path, "w", encoding="utf-8") as file_handle:
        for index, img_path in enumerate(img_list, start=1):
            ...
            if cv_imwrite(save_path, img):
                file_handle.write(f"./lprnet8_quant_dataset/{save_name}\n")
                written += 1
