#ifndef ITS_RKNN_DEMO_YOLOV8_H_
#define ITS_RKNN_DEMO_YOLOV8_H_
...
int inference_yolov8_model_nolb(rknn_app_context_t* app_ctx,
                                image_buffer_t* img,
                                object_detect_result_list* od_results);
int inference_yolov8_model_preprocessed(rknn_app_context_t* app_ctx,
                                        object_detect_result_list* od_results);
