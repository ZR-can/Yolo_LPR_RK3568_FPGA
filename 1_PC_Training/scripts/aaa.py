...
INPUT_DIR = Path(r"D:\Yolo_LPR_RK3568_FPGA_Project\1_PC_Training\datasets\lprnet_7char\train")
# 紧凑裁剪后的新输出路径
OUTPUT_DIR = Path(r"D:\Yolo_LPR_RK3568_FPGA_Project\1_PC_Training\datasets\lprnet_7char_tight_train")
