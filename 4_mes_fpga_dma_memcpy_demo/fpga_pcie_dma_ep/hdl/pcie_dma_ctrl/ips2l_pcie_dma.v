...
//    input           [5:0]               i_radm_grant_tlp_type   ,
    ...
    //BAR0 write monitor for project-level V2 mailbox logic
    output  wire                        o_bar0_wr_en            ,
    output  wire    [ADDR_WIDTH-1:0]    o_bar0_wr_addr          ,
    output  wire    [127:0]             o_bar0_wr_data          ,
    output  wire    [15:0]              o_bar0_wr_byte_en
    //debug
...
//    .i_radm_grant_tlp_type      (i_radm_grant_tlp_type      ),
    ...
    .o_bar0_wr_en               (o_bar0_wr_en               ),
    .o_bar0_wr_addr             (o_bar0_wr_addr             ),
    .o_bar0_wr_data             (o_bar0_wr_data             ),
    .o_bar0_wr_byte_en          (o_bar0_wr_byte_en          ),
    //**********************************************************************
    //to tx top
    //req rcv
    .o_mrd_tc                   (mrd_tc                     ),
